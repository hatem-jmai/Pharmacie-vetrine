...
<!-- Mirrored from wahabali.com/work/medical-guide/index4.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:14:06 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<ul class="submenu">
						...
						<li class="select-menu"> <a href="index4.php">Home Page 4</a> </li>
					</ul>
					</li>
				...
				<ul>
					<li class="select"><a href="index.php">Home</a>
                    	<ul>
							...
							<li> <a href="index2.php">Home Page 2</a> </li>
							<li> <a href="index3.php">Home Page 3</a> </li>
							<li class="select"> <a href="index4.php">Home Page 4</a> </li>
                        </ul>
                    </li>
...
<li><span class="day">Sunday</span> <span class="divider">-</span> <span class="time">9.45 - 15.00</span></li>
    ...
    <div class="link"><img src="images/timetable-menu-dark.png" alt=""></div>
   ...
   <div class="main-banner-three">
	<div class="container">
		<div class="detail">
			...
			<span class="title">Life can be Better</span>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="service-sec">
						...
						<p>If you need a doctor for to consectetuer Lorem ipsum dolor, consectetur adipiscing elit eros  adipiscing nonummy.</p>
					</div>
				</div>
...
<!-- Mirrored from wahabali.com/work/medical-guide/index4.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:14:07 GMT -->
</html>