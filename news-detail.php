...
<!-- Mirrored from wahabali.com/work/medical-guide/news-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:22:15 GMT -->
<head>
				...
				<div class="row">
					...
					<div class="col-md-8">
							...
							<div class="news-detail">
								...
								<div class="detail">
									...
									<div class="quote"><img src="images/quote.jpg" alt=""> <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span></div>
							...
							<div class="comment-box">
								...
								<div class="comment-box">
									...
									<div class="detail">
										<a href="#.">Reply</a>
										<span class="name">Fahid Javed</span>
										<span class="date">September 30, 2016 at 3:21 pm</span>
							...
							<div class="leave-reply">
								...
								<div class="form">
									<input type="text" data-delay="300" placeholder="Your full name" name=" " class="input">
									<input type="text" data-delay="300" placeholder="E-mail Address" name=" " class="input">
									<input type="text" data-delay="300" placeholder="Subject" name=" " class="input last">
					...
					<div class="col-md-4">
						...
						<div class="recent-posts">
							...
							<div class="post-sec">
								<a href="blog-detail.php"><img src="images/blog/side-bar/recent-post1.jpg" alt=""></a>
								<a href="blog-detail.php" class="title">Geometric Landscapes Heartologic</a>
								<span class="date">11 Minutes ago</span>
							</div>
							
							<div class="post-sec">
								<a href="blog-detail.php"><img src="images/blog/side-bar/recent-post2.jpg" alt=""></a>
								<a href="blog-detail.php" class="title">Geometric Landscapes Heartologic</a>
								<span class="date">2 Days ago</span>
							</div>
							<div class="post-sec">
								<a href="blog-detail.php"><img src="images/blog/side-bar/recent-post3.jpg" alt=""></a>
								<a href="blog-detail.php" class="title">Geometric Landscapes Heartologic</a>
...
<!-- Mirrored from wahabali.com/work/medical-guide/news-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:22:17 GMT -->
</html>