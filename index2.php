...
<!-- Mirrored from wahabali.com/work/medical-guide/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:10:52 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<ul class="submenu">
                        ...
                        <li class="select-menu"> <a href="index2.php">Home Page 2</a> </li>
				...
				<ul>
					<li class="select"><a href="index.php">Home</a>
                    	<ul>
							...
							<li class="select"> <a href="index2.php">Home Page 2</a> </li>
							<li> <a href="index3.php">Home Page 3</a> </li>
							<li> <a href="index4.php">Home Page 4</a> </li>
                        </ul>
                    </li>
...
<div class="link"><img class="time-tab" src="images/timetable-menu.png" alt=""></div>
   ...
   <div class="tp-banner-container">
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
		<!-- MAIN IMAGE -->
		<img src="images/slides/banner-img4.jpg" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
		...
		<div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
			...
			style="z-index: 10; max-width: auto; max-height: auto; font-size: 52px; white-space: nowrap;">BETTER TECHNOLOGY FOR
		</div>
		...
		<div class="tp-caption black_thin_34 black_thin_34_bold customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap; font-size: 52px;">BETTER HEALTHCARE
		</div>
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
		...
		<div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap; font-size: 52px;">Medical guide
		</div>
		...
		<div class="tp-caption black_thin_34 black_thin_34_bold customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap; font-size: 52px;">That You Can Trust
		</div>
    ...
    <li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
		<!-- MAIN IMAGE -->
		<img src="images/slides/banner-img6.jpg" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
    ...
    <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
		<!-- MAIN IMAGE -->
		<img src="images/slides/banner-img7.jpg" alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
		...
		<div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap; font-size: 52px;">Medical and Health
		</div>
		...
		<div class="tp-caption black_thin_34 black_thin_34_bold customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap; font-size: 52px;">html template
		</div>
...
<div class="tp-bannertimer"></div>	</div>
   ...
   <div class="services-three">
        ...
        <div class="serv-sec serv-sec2">
        	<h3>Shop Medicine</h3>
            <p>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus.</p>
            <a href="http://login.ma-potheke.de/">Purchase now</a>
        </div>
        
        <div class="serv-sec serv-sec3">
        	<h3>Our Passion</h3>
            <p>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus.</p>
            <a href="about-us2.php">learn more</a>
        </div>
...
<!-- Mirrored from wahabali.com/work/medical-guide/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:12:49 GMT -->
</html>