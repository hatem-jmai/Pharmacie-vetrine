...
<!-- Mirrored from wahabali.com/work/medical-guide/patient-and-family.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:15:52 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
						...
						<li class="select-menu"> <a href="patient-and-family.php">Patient and Family</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
							...
							<li> <a href="appointment.php">Appointment</a> </li>
							<li> <a href="departments.php">Departments</a> </li>
							<li class="select"> <a href="patient-and-family.php">Patient and Family</a> </li>
							<li> <a href="team-members.php">Team Members One</a> </li>
							<li> <a href="team-members2.php">Team Members Two</a> </li>
							<li> <a href="research.php">Research</a> </li>
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-md-12">
                    ...
                    <div class="paging">
                		<h2>Patient and Families</h2>
						<ul>
						<li><a href="index.php">Home</a></li>
						<li><a href="#.">Pages</a></li>
						<li><a>Patient and Families</a></li>
						</ul>
                    </div>
