...
<!-- Mirrored from wahabali.com/work/medical-guide/services2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:15:52 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
                        ...
                        <li class="select-menu"> <a href="services2.php">Services Two</a> </li>
			...
			<nav id="menu">
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
                        	<li> <a href="services.php">Services</a> </li>
							<li class="select"> <a href="services2.php">Services Two</a> </li>
							<li> <a href="appointment.php">Appointment</a> </li>
							<li> <a href="departments.php">Departments</a> </li>
							<li> <a href="patient-and-family.php">Patient and Family</a> </li>
							<li> <a href="team-members.php">Team Members One</a> </li>
