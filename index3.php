...
<!-- Mirrored from wahabali.com/work/medical-guide/index3.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:12:49 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<ul class="submenu">
                        ...
                        <li class="select-menu"> <a href="index3.php">Home Page 3</a> </li>
                    ...
                    <li class="parent"><a href="#.">Pages</a>
                        ...
                        <li> <a href="services2.php">Services Two</a> </li>
						<li> <a href="appointment.php">Appointment</a> </li>
						<li> <a href="departments.php">Departments</a> </li>
						<li> <a href="patient-and-family.php">Patient and Family</a> </li>
						<li> <a href="team-members.php">Team Members One</a> </li>
						<li> <a href="team-members2.php">Team Members Two</a> </li>
                    ...
                    <li class="parent"> <a href="gallery-nimble-four.php">Gallery</a>
                    ...
                    <li><a href="http://login.ma-potheke.de/">ma-potheke</a></li>
                    
					<li class="parent"> <a href="contact-us2.php">Contact Us</a>
				...
				<ul>
					<li class="select"><a href="index.php">Home</a>
                    	<ul>
							...
							<li> <a href="index2.php">Home Page 2</a> </li>
							<li class="select"> <a href="index3.php">Home Page 3</a> </li>
							<li> <a href="index4.php">Home Page 4</a> </li>
                        </ul>
                    </li>
					...
					<li> <a href="gallery-nimble-four.php">Gallery</a>
					...
					<li> <a href="contact-us2.php">Contact Us</a>
   ...
   <div class="tp-banner-container">
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
		...
		<div class="tp-caption lft customout rs-parallaxlevel-0"
			...
			style="z-index: 4;"><img src="images/heart-icon.png" alt="" >
		...
		<div class="tp-caption grey_heavy_72 skewfromrightshort tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Heart
		</div>
        ...
        <div class="tp-caption grey_heavy_72-light skewfromrightshort tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Specialist
		</div>
		...
		<div class="tp-caption grey_regular_18 customin tp-resizeme rs-parallaxlevel-0"
			...
			data-endelementdelay="0.1"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><div style="text-align:left;">If you need a doctor for to consectetuer Lorem ipsum dolor, consectetur <br/>adipiscing elit. Ut volutpat eros  adipiscing elit Ut volutpat. </div>
		</div>
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
        ...
        <div class="tp-caption grey_heavy_72-light skewfromleftshort fadeout tp-resizeme rs-parallaxlevel-10"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Services
		</div>
        ...
        <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap; font-size: 18px;">Managing your Family Health care.
		</div>
        ...
        <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap; font-size: 18px;">Cancer Researchers Honored
		</div>
        ...
        <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap; font-size: 18px;">Orthopedic Health keeps you Active
		</div>
        ...
        <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index:12000;"><a href="services.php"><img src="images/slides/icon1.png" alt="" ></a>
		</div>
        ...
        <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index:12000;"><a href="services.php"><img src="images/slides/icon2.png" alt="" ></a>
		</div>
         ...
         <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index:12000;"><a href="services.php"><img src="images/slides/icon3.png" alt="" ></a>
		</div>
        ...
        <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index:12000;"><a href="services.php"><img src="images/slides/icon4.png" alt="" ></a>
		</div>
        ...
        <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
			...
			data-endelementdelay="0.1"
			data-endspeed="1000"
			style="z-index:12000;"><a href="services.php"><img src="images/slides/view-all.png" alt="" ></a>
		</div>
	...
	<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
        ...
        <div class="tp-caption grey_heavy_72-light customin randomrotateout tp-resizeme rs-parallaxlevel-10"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Leading the Way in
		</div>
		...
		<div class="tp-caption grey_heavy_72 customin randomrotateout tp-resizeme rs-parallaxlevel-10"
			...
			data-elementdelay="0.1"
			data-endelementdelay="0.1"
			style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">Research & Development
		</div>
		...
		<div class="tp-caption grey_regular_18 customin tp-resizeme rs-parallaxlevel-0"
			...
			data-elementdelay="0.05"
			data-endelementdelay="0.1"
			style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><div style="text-align:left;">Whether it's picking up the photne and calling you back.</div>
		</div>
		...
		<div class="tp-caption grey_regular_18 customin tp-resizeme rs-parallaxlevel-0"
			...
			<a href="about-us.php" class="read-more" style=" line-height: initial; color: #fff; text-transform: uppercase; font-weight: 500; padding: 12px 36px; display: inline-block; font-size: 18px;">read more</a>
			</div>
		</div>
              ...
              <div id="owl-demo4" class="owl-carousel">
                ...
                <div class="post item">
                    ...
                    <div class="detail">
                        ...
                        <a href="team-member-detail.php">- View Profile</a>
                    </div>
              ...
              <div id="owl-demo" class="owl-carousel">
                ...
                <div class="post item">
                        ...
                        <div class="detail">
                            ...
                            <h4><a href="news-detail.php">Center for Medical</a></h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eros...</p>
                            <span><i class="icon-clock3"></i> Apr 22, 2016</span>
                            <span class="comment"><a href="news-detail.php"><i class="icon-icons206"></i> 5 Comments</a></span>
                        </div>
                    </div>
                <div class="post item">
                    ...
                    <div class="detail">
                        ...
                        <h4><a href="news-detail.php">Laboratory Tests</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eros...</p>
                        <span><i class="icon-clock3"></i> Apr 09, 2016</span>
                        <span class="comment"><a href="news-detail.php"><i class="icon-icons206"></i> 3 Comments</a></span>
                    </div>
                </div>
                ...
                <div class="post item">
                    ...
                    <div class="detail">
                        <img src="images/news-dr1.jpg" alt="">
                        <h4><a href="news-detail.php">Research Center</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eros...</p>
                        <span><i class="icon-clock3"></i> Mar 28, 2016</span>
                        <span class="comment"><a href="news-detail.php"><i class="icon-icons206"></i> 0 Comments</a></span>
                    </div>
                </div>
                ...
                <div class="post item">
                    ...
                    <div class="detail">
                        <img src="images/news-dr2.jpg" alt="">
                        <h4><a href="news-detail.php">Child Birth</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eros...</p>
                ...
                <div class="post item">
                    ...
                    <div class="detail">
                        <img src="images/news-dr2.jpg" alt="">
                        <h4><a href="news-detail.php">Special Treatment</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit eros...</p>
                        <span><i class="icon-clock3"></i> Mar 04, 2016</span>
                        <span class="comment"><a href="news-detail.php"><i class="icon-icons206"></i> 11 Comments</a></span>
                    </div>
                </div>    
        ...
        <div class="footer-bottom">
        	<div class="container">
            	<div class="row">
                    ...
                    <div class="col-md-6">
                    	<span class="copyrights">Copyright &copy; 2021 Medical Guide. All right reserved.</span>
                    </div>
...
<!-- Mirrored from wahabali.com/work/medical-guide/index3.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:14:06 GMT -->
</html>