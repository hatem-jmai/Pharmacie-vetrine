...
<!-- Mirrored from wahabali.com/work/medical-guide/news-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:19:08 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<ul class="submenu">
						...
						<li class="select-menu"> <a href="news-single.php">Single Post</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">News Posts</a>
                    	<ul>
                        	<li> <a href="news-sidebar.php">Sidebar</a> </li>
							<li> <a href="news-text.php">Text-Based</a> </li>
							<li class="select"> <a href="news-single.php">Single Post</a> </li>
							<li> <a href="news-double.php">Double Post</a> </li>
							<li> <a href="news-masonary.php">Masonary</a> </li>
                        </ul>
                    </li>
