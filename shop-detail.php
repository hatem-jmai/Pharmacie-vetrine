...
<!-- Mirrored from wahabali.com/work/medical-guide/shop-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:22:34 GMT -->
<head>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li clas="item-select "><a href="http://login.ma-potheke.de/">ma-potheke</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select "><a href="http://login.ma-potheke.de/">ma-potheke</a></li>
    ...
    <div id="page">
			...
			<nav id="menu">
				<ul>
					...
					<li class="select"><a href="http://login.ma-potheke.de/">ma-potheke</a></li>
        	...
        	<div class="row">
            	<div class="col-md-12">
                    ...
                    <div class="paging">
						...
						<li><a href="#.">ma-potheke</a></li>
						<li><a>Shop Detail</a></li>
						</ul>
                    </div>
            ...
            <div class="row">
					<div class="col-md-5">
						<div class="product-detail-slider">
							<div class="rslides" id="product-detail-slider">
								<img src="images/shop/product-detail-img1.jpg" alt="">
								<img src="images/shop/product-detail-img1.jpg" alt="">
								<img src="images/shop/product-detail-img1.jpg" alt="">
							</div>
						</div>
					...
					<div class="col-md-7">
						<div class="product-detail-description">
							...
							<a href="#." class="btn btn-default btn-dark btn-medium btn-square">add to cart</a>
							<div class="clearfix"></div>
							<br>
							<p><strong>Categories:</strong>  Clothing, T-shirts, Tie, Suite</p>
							...
							<div class="review" id="comments">
									...
									<li class="comment">
										<div class="comment_container">
											<div class="comment-avartar">
												<img width="60" height="60" alt="" src="images/comment-img.jpg">
											</div>
								...
								<div class="add-review-form" id="add-review-form" style="display:none">
									...
									<div class="review_form_thumb text-center">
										<img src="images/add-review-img.jpg" class="img-circle" alt="">
									</div>
				...
				<div class="shop">
					...
					<ul class="shop full-width clearfix list-unstyled">
						<li>
							<div class="product">
								...
								<div class="product-description clearfix">
									<h3><a href="#.">Adidas Winter Cap</a></h3>
									<p class="price">&pound;55.00</p>
									<span class="double-border"></span>
									<a href="#." class="product-cart-btn pull-left"><i class="icon-basket"></i> Add to cart</a>
									<a href="shop-detail.php" class="product-detail-btn pull-right"><i class="icon-browser"></i> Details</a>
								</div>
							</div>
						</li>
						<li>
						...
						<li>
							<div class="product">
								<div class="product-thumb">
									<a href="#."><img src="images/shop/8.jpg" alt=""></a>
								</div>
								<div class="product-description clearfix">
									<h3><a href="#.">Adidas Winter Cap</a></h3>
									<p class="price">&pound;55.00</p>
...
<!-- Mirrored from wahabali.com/work/medical-guide/shop-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:22:35 GMT -->
</html>