...
<!-- Mirrored from wahabali.com/work/medical-guide/team-members.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:15:52 GMT -->
<head>
  ...
  <div id="header-2" style="display:none">
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
						...
						<li class="select-menu"> <a href="team-members.php">Team Members One</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
							...
							<li> <a href="departments.php">Departments</a> </li>
							<li> <a href="patient-and-family.php">Patient and Family</a> </li>
							<li class="select"> <a href="team-members.php">Team Members One</a> </li>
							<li> <a href="team-members2.php">Team Members Two</a> </li>
							<li> <a href="research.php">Research</a> </li>
   ...
   <!--Start Team Detail-->
        ...
        <div id="filters-container" class="cbp-l-filters-list ">
            ...
            <div data-filter=".health-care" class="cbp-filter-item">Primary Health Care</div>
            <div data-filter=".traumatology" class="cbp-filter-item">Traumatology</div>
            <div data-filter=".dental" class="cbp-filter-item">Medical Dental</div>
            <div data-filter=".gynaecological" class="cbp-filter-item cbp-l-filters-list-last">Gynaecological</div>
        </div>

        <div id="grid-container" class="cbp">
            <div class="cbp-item traumatology motion">
			...
			<div class="cbp-item gynaecological motion">
                <div class="cbp-caption">
                    <div class="cbp-caption-defaultWrap">
			...
			<div class="cbp-item health-care motion">
                <div class="cbp-caption">
                    <div class="cbp-caption-defaultWrap">
				...
				<div class="detail">
					<h6>J. Vicente Gaby</h6>
					<span>Senior Doctor at Medical Life</span>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec eros eget nisl fringilla commodo.</p>
					<a href="team-member-detail.php">- View Profile</a>
                </div>
			...
			<div class="cbp-item dental motion">
                <div class="cbp-caption">
                    <div class="cbp-caption-defaultWrap">
                        <img src="images/team-member7.jpg" alt="">
                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
...
<!-- Mirrored from wahabali.com/work/medical-guide/team-members.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:16:30 GMT -->
</html>