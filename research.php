...
<!-- Mirrored from wahabali.com/work/medical-guide/research.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:16:30 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
						...
						<li class="select-menu"> <a href="research.php">Research</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
							...
							<li> <a href="team-members.php">Team Members One</a> </li>
							<li> <a href="team-members2.php">Team Members Two</a> </li>
							<li class="select"> <a href="research.php">Research</a> </li>
