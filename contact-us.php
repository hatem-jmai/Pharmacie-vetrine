...
<!-- Mirrored from wahabali.com/work/medical-guide/contact-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:22:15 GMT -->
<head>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<li class="item-select parent"> <a href="contact-us2.php">Contact Us</a>
					<ul class="submenu">
                        <li class="select-menu"> <a href="contact-us.php">Contact-Us One</a> </li>
                        <li> <a href="contact-us2.php">Contact-Us Two</a> </li>
					</ul>
					</li>
    ...
    <div id="page">
			...
			<nav id="menu">
				<ul>
					...
					<li class="select"> <a href="contact-us2.php">Contact Us</a>
                    	<ul>
                        	<li class="select"> <a href="contact-us.php">Contact-Us One</a> </li>
							<li> <a href="contact-us2.php">Contact-Us Two</a> </li>
                        </ul>
                    </li>
