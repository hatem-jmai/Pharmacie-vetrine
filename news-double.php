...
<!-- Mirrored from wahabali.com/work/medical-guide/news-double.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:19:08 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<ul class="submenu">
						...
						<li class="select-menu"> <a href="news-double.php">Double Post</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">News Posts</a>
                    	<ul>
							...
							<li> <a href="news-text.php">Text-Based</a> </li>
							<li> <a href="news-single.php">Single Post</a> </li>
							<li class="select"> <a href="news-double.php">Double Post</a> </li>
							<li> <a href="news-masonary.php">Masonary</a> </li>
                        </ul>
                    </li>
		...
		<div class="news-posts">
			<div class="container">
				<div class="row">
							...
							<div class="news-sec">
								...
								<div id="demo">
									...
									<div id="blog-slide" class="owl-carousel">
										<img src="images/blog/doble-bar/post-img2.jpg" alt="">
										<img src="images/blog/doble-bar/post-img4.jpg" alt="">
										<img src="images/blog/doble-bar/post-img6.jpg" alt="">
									</div>
					...
					<div class="col-md-6">
							<div class="news-sec">
								<img src="images/blog/doble-bar/post-img3.jpg" alt="">
								<div class="detail">
									<span>March 7, 2015 / By Rockal</span>
									<h3>Standard Post Format</h3>
									<p>Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Sed ut perspiciatis unde omnis iste natus error inventore. </p>
					...
					<div class="col-md-6">
							<div class="news-sec">
								<img src="images/blog/doble-bar/post-img5.jpg" alt="">
								<div class="detail">
									<span>March 7, 2015 / By Rockal</span>
									<h3>Standard Post Format</h3>
									<p>Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Sed ut perspiciatis unde omnis iste natus error inventore. </p>
...
<!-- Mirrored from wahabali.com/work/medical-guide/news-double.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:20:37 GMT -->
</html>