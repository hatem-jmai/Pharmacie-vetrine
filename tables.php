...
<!-- Mirrored from wahabali.com/work/medical-guide/tables.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 08:16:30 GMT -->
<head>
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
						...
						<li class="select-menu"> <a href="tables.php">Pricing tabels</a> </li>
						</ul>
                    </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
							...
							<li> <a href="team-members2.php">Team Members Two</a> </li>
							<li> <a href="research.php">Research</a> </li>
							<li class="select"> <a href="tables.php">Pricing tabels</a> </li>
                        </ul>
                    </li>
   		...
   		<div class="container">
			...
			<div class="row">
				<div class="pricing-table text-center col-md-4">
					...
					<p class="table-price"><span class="currency">&pound;</span>29<span>per month</span></p>
					<ul class="list list-unstyled">
						<li>24/7 Free Tech Support</li>
						<li>2GB Bandwidth Available</li>
						<li>Unlimited User Access</li>
				...
				<div class="pricing-table text-center col-md-4 highlight">
					<h3 class="pricing-table-heading">Standard</h3>
					<p class="table-price"><span class="currency">&pound;</span>89<span>per month</span></p>
					<ul class="list list-unstyled">
						<li>24/7 Free Tech Support</li>
						<li>2GB Bandwidth Available</li>
						<li>Unlimited User Access</li>
				...
				<div class="pricing-table text-center col-md-4">
					<h3 class="pricing-table-heading">Exclusive</h3>
					<p class="table-price"><span class="currency">&pound;</span>149<span>per month</span></p>
					<ul class="list list-unstyled">
						<li>24/7 Free Tech Support</li>
						<li>2GB Bandwidth Available</li>
						<li>Unlimited User Access</li>
